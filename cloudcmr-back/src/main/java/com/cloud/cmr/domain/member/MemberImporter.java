...
public class MemberImporter {
    ...
    public Member importMemberFromExternalSource(String licenceNumber, String lastName, String firstName, String email,
        ...
        Member member = memberRepository.findByLicenceNumber(licenceNumber)
                .or(() -> memberRepository.findByLastNameAndFirstNameAndBirthDate(lastName, firstName, birthDate))
